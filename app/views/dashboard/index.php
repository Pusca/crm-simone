...
<?php else: ?>
    <form method="get" action="<?= e(base_url('dashboard')) ?>" class="no-print mb-4 flex flex-wrap items-end gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <div>
